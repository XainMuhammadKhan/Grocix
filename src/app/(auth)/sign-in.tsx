...
export default function SignInScreen() {
    ...
    return (
        <SafeAreaView className='flex-1 bg-primary dark:bg-secondary'>
            ...
            <View className='absolute right-[-76] top-40 h-72 w-72 rounded-full bg-primary/70 dark:bg-background/35' />

            <View className='px-6 pt-4'>
                <Text className='text-center text-5xl font-extrabold tracking-tight text-primary-foreground dark:text-foreground uppercase font-mono '>Grocix</Text>
                ...
                <View className="mt-6 rounded-[30px] border border-white/20 bg-white/10 p-3">
                    <Image source={require("../../../assets/images/auth.png")
                        ...
                        style={{ width: "100%", height: 300 }} contentFit="contain" />
            ...
            {/* <View className="mt-8 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6">
                <View className="self-center rounded-full bg-secondary px-3 py-1">
                    <Text
                        className="text-xs font-semibold uppercase tracking-[1px] text-secondary-foreground">
                        Welcome Back
                    </Text>
                </View>
                <Text className="mt-2 text-center text-sm leading-6 text-muted-foreground">
                    Choose a social provider and jump right into your personalized grocery planning experience
                </Text>
                <View className="mt-6">
            ...
            <View className="mt-8 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6">
                ...
                {/* Description */}
                <Text className="mt-10 text-center text-sm leading-6 text-muted-foreground">
                ...
                <Text className="mt-10 text -center text-sm leading-5 text-muted-foreground">
